...
* @param xsize MiddleEarth x axis
* @param ysize MiddleEarth y axis
* @param num_cities Cities in MiddleEarth 
...
* @return This is void function so returns nothing
*/
...
*
* @return This function is void so returns nothing
*
*/
...
* @return float value of distance between two cities
*
